# Contributing to node-tslint-rules

We would love for you to contribute to **`node-tslint-rules`** and help make it even better than it is today! As a contributor,
...
Help us keep **`node-tslint-rules`** open and inclusive. Please read and follow our [Code of Conduct][coc].
...
You can file new issues by filling out our [new issue form](https://github.com/fulls1z3/node-tslint-rules/issues/new).

### <a name="submit-pr"></a> Submitting a Pull Request (PR)
Before you submit your Pull Request (PR) consider the following guidelines:

* Search [GitHub](https://github.com/fulls1z3/node-tslint-rules/pulls) for an open or closed PR that relates to your submission.
...
* Push your branch to GitHub:
    ...
    ```
* In GitHub, send a pull request to `node-tslint-rules:master`.
...
the `node-tslint-rules` change log**.
...
Samples: (even more [samples](https://github.com/fulls1z3/node-tslint-rules/commits/master))
```
...
[coc]: https://github.com/fulls1z3/node-tslint-rules/blob/master/CODE_OF_CONDUCT.md
[github]: https://github.com/fulls1z3/node-tslint-rules
